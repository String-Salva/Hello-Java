...
public class AccessModifiersExercises {
    ...
    public static class Product {
        ...
        public void setPrice(double price) {
            if (price > 0) {
                ...
                System.out.println("Precio mal introducido, introduce otro por favor");
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Person salva = new Person();

        salva.setAge(26);
        salva.setName("Salva");


        System.out.println("Su nombre es " + salva.getName() + " y tiene " + salva.getAge() + " años");
